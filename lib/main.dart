...
import 'package:storyadminpanel/theme/theme_controller.dart';
  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
        options: FirebaseOptions(
            apiKey: "AIzaSyBF9tG7Sg5vkzCCALHjR2_AofP6bKXTsig",
            authDomain: "story-admin-panel.firebaseapp.com",
            projectId: "story-admin-panel",
            storageBucket: "story-admin-panel.appspot.com",
            messagingSenderId: "524400571574",
            appId: "1:524400571574:web:029ba3f2dc49fb80982217",
            measurementId: "G-SZNFS0GJ2K"
        )
    );
  } else {
    await Firebase.initializeApp();
    ...
    return GetBuilder<ThemeController>(
      builder: (provider) {
        ...
        return GetMaterialApp(
          ...
          initialRoute: KeyUtil.splashPage,
