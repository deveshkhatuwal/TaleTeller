...
class SettingController extends GetxController{
  ...
  void onInit() {
    ...
    if (appDetailModel != null) {
      ...
      if(appDetailModel!.aboutUs!=null && appDetailModel!.aboutUs!.isNotEmpty){
        Delta delta = new Delta()..insert(decode(removeAllHtmlTags(appDetailModel!.aboutUs ?? "")));
  ...
  bool checkValidation(BuildContext context) {
    if (isNotEmpty(appNameController.text)) {
    if (isNotEmpty(appAdIdController.text)) {
      ...
      showCustomToast(
          message: 'Enter App name...', title: 'Error', context: context);
      return false;
    }
