...
class NotificationController extends GetxController {
  ...
  //       Uri.parse('https://fcm.googleapis.com/v1/projects/com.taleteller.adminpanel/messages:send HTTP/1.1'),
  //       // Uri.parse('https://fcm.googleapis.com/v1/{parent=com.taleteller.com.taleteller.adminpanel}/messages:send'),
  ...
  //         "collapse_key": "string",
  //         "priority": 'high',
  //         "restricted_package_name": "com.taleteller.com.taleteller.adminpanel",
  //         "data": {
  //
  //         },
  //         "notification": {
  ...
  Future<bool> sendFcmMessage(BuildContext context,String title, String message,String token,String image) async {
    print("image----${image}");
    String imageUrl = "";
    ...
    try {
      ...
      var header = {
        ...
        "Authorization":
        "key=AAAAehi1tLY:APA91bH0EoT8VgCDxQ__KiZiTLdtdeHysSPhL8UlvKngcfPEvnAfezTM73aG02iFSEAivCGWMg-fi0668c5WN_wpzzxjzzus0rEcjqDaBmTg8E1y0j-Q4uTlUzhWPYjhlnnJ0eRjGPeS",
      };
      var request =
      {
        "notification": {
  ...
  Future<bool> sendFcmMessageWihStory(BuildContext context,String token,StoryModel storyModel) async {
    String desc1 = removeAllHtmlTags(storyModel.desc!);

    String desc = desc1.substring(0,150);
    ...
    try {
      ...
      var header = {
        "Content-Type": "application/json",
        "Authorization": "key=AAAAehi1tLY:APA91bH0EoT8VgCDxQ__KiZiTLdtdeHysSPhL8UlvKngcfPEvnAfezTM73aG02iFSEAivCGWMg-fi0668c5WN_wpzzxjzzus0rEcjqDaBmTg8E1y0j-Q4uTlUzhWPYjhlnnJ0eRjGPeS",
      };
      var request =
      {
        "notification": {
          ...
          "click_action": "FLUTTER_NOTIFICATION_CLICK_STORY",
          "link": linkController.text,
