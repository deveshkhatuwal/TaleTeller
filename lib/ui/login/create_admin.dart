...
class CreateAdminPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _CreateAdminPage();
  }
}

class _CreateAdminPage extends State<CreateAdminPage> {
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      getTextWidget(context, 'Admin', 70, getFontColor(context),
  ...
  void _login() async {
    bool? isLoginComplete = await LoginData.createAdmin(
