...
import 'package:storyadminpanel/ui/story/subwidget/mobile_widget.dart';
import 'package:storyadminpanel/ui/story/subwidget/web_widget.dart';
    ...
    return SafeArea(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            getTextWidget(context, 'Stories', 75, getFontColor(context),
        ...
        function: () {
          getCommonDialog(
              ...
              title: storyModel.isActive!
                  ? 'Do you want to de-active this story?'
                    ...
                    getCommonDialog(
                        ...
                        function: () {
                          FirebaseData.deleteBatch(() {
                            ...
                            }, storyId, KeyTable.recentList,
                              KeyTable.storyId,
                            );


                          }, storyId, KeyTable.sliderList,
                              KeyTable.storyId,
                              );
                          ...
                          //     doc: storyId,
                          //     function: () {
                          //       // FirebaseData.deleteRecentStory(context: context,function: (doc){
                          //       //   FirebaseData.deleteData(tableName: KeyTable.recentList, doc: doc, function: () {
                          //       //
                          //       //
                          //       //
                          //       //
                          ...
                          //       //       FirebaseData.refreshSliderData();
                          //       //
                          //       //     },storyModel.id!,KeyTable.sliderList,KeyTable.storyId,slider: true);
                          //       //
                          //       //   });
                          //       //
